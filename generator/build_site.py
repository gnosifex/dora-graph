...
<title>DORA-Regulatorik im Zeitraffer</title>
<style>
...
<div class="panel" id="head">
  <h1>DORA-Regulatorik im Zeitraffer</h1>
  <div class="sub">Aufbau des Korpus entlang der echten Zeitachse</div>
  <div id="clock">—</div>
...
<div class="panel" id="legend">
  ...
  <div class="note">
    ...
    Knotengröße ≈ Textumfang, aber nur bei eigenständigen Dokumenten; Artikel, Q&As und
    Aufsichtsseiten sind einheitlich klein.<br>
    Zeitpunkt = Erstfassung des Instruments. Bestand vor 2006 ab Start sichtbar.<br>
    Der Bestand wartet dicht um die Bildmitte; am DORA-Datum schlägt der DORA-Kreis dort
    ein und drückt ihn auf seine Endpositionen nach außen.
  </div>
</div>
...
(function () {
  ...
  resize(); buildTicks(); syncScrub(); setPlaying(true);
  requestAnimationFrame(frame);
})();
</script>
</body>
