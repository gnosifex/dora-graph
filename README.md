...
- **Gestrichelte Ränder markieren referenziertes Material:** Recht fremder Rechtsordnungen (KWG, CRR, CRD, Normungs-VO) und Standards, auf die der DORA-Stack verweist, ohne dass sie zu ihm gehören. Sie liegen deshalb nur ausschnittsweise oder als Stub im Korpus — ihr Umfang ist hochgerechnet (Referenzakte) bzw. aus der Seitenzahl geschätzt (Standards).
